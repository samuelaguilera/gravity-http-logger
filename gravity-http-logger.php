 ...
 * Description: Logs the code, message, headers and body of HTTP responses provided by WordPress for requests sent to third-party services.
 * Version: 1.0.1
...
define( 'GRAVITY_HTTP_LOGGER_VERSION', '1.0' );
